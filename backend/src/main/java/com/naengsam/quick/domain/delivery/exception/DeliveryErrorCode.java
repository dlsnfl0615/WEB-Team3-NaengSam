...
public enum DeliveryErrorCode implements BaseErrorCode {
    ...
    DELIVERY_COMPLETION_NOT_ALLOWED_BEFORE_PICKUP(
            HttpStatus.CONFLICT, "DELIVERY_014", "픽업이 완료되지 않아 배달 완료 처리를 할 수 없습니다."),
    ...
    PICKUP_NOT_COMPLETED_HANDOFF_PENDING(HttpStatus.CONFLICT, "DELIVERY_018", "파트너 인계 과정에는 픽업 완료가 불가능합니다."),
