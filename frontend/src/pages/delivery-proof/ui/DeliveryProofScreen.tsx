...
/**
 * 실제 인증(픽업/전달 완료): 파일 선택 → presign → S3 PUT → 전이 API.
 * presign/전이 API는 공통 axios 인스턴스로 호출하지만, S3 PUT은 발급받은 presigned URL로
 * 직접 fetch한다(공통 인스턴스를 타면 host가 앱 자신의 origin으로 바뀐다).
 */
